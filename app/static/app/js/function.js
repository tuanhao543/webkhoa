...
function DrawingSchedules() {
    ...
    //$("#divThoiKhoiBieu").html("<b style='color:red'>Đang tải dữ liệu .....</b>");
...
function LoadClassStudentByProfessorcustomDll() {
    ...
    $.getJSON("/Professor/AjaxClassStudent?YearStudy=" + YearStudy + '&TermID=' + TermID)
        .done(function (data) {
            ...
            $.each(data, function (key, item) {
                // Add a list item for the product.
                $("<option value=" + item.ClassStudentID + ">" + item.ClassStudentName + " </option>").appendTo($('.ddlClassStudentMany'));
            });
